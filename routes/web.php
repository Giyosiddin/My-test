...
Route::post('file/upload', 'PostController@uploads')->name('blog.upload');
Route::post('file/archive', 'PostController@archive')->name('blog.archive');
...
Route::group($dataGroup,function(){
